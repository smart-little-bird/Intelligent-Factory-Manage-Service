...
namespace Intelligent.Factory.Management.API.Migrations
{
    ...
    [Migration("20240407152040_add_defaultValue_entryTime")]
    partial class add_defaultValue_entryTime
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Intelligent.Factory.Management.Domain.AggregatesModel.EmployeeAggregate.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Intelligent.Factory.Management.Domain.AggregatesModel.EmployeeAggregate.Employee", b =>
                {
                    b.OwnsOne("Intelligent.Factory.Management.Domain.AggregatesModel.EmployeeAggregate.BasicInfo", "BasicInfo", b1 =>
                        {
                            ...
                            b1.ToTable("employee", "intelligent_factory_management");

                            b1.WithOwner()
                                .HasForeignKey("EmployeeId");
                        });

                    b.OwnsOne("Intelligent.Factory.Management.Domain.AggregatesModel.EmployeeAggregate.WorkingInfo", "WorkingInfo", b1 =>
                        {
                            b1.Property<int>("EmployeeId")
                                .HasColumnType("int");

                            b1.Property<string>("EmployeeType")
                                .IsRequired()
                                .HasColumnType("nvarchar(max)")
                                .HasColumnName("EmployeeType");

                            b1.Property<double>("WorkingYear")
                                .HasColumnType("float")
                                .HasColumnName("WorkingYear");
